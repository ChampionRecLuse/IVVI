...
# Luofeng Liao Project
_ENV_INFO.update({
    'Instrumental_Variable_Value_Iteration': {
        'path': 'mbbl.env.LLP.IVVI',
        'ob_size' : 1, 'action_size': 1, 'max_length': 1000
    },
    'Instrumental_Variable_Value_Iteration_test': {
        'path': 'mbbl.env.LLP.IVVI_test',
        'ob_size' : 1, 'action_size': 1, 'max_length': 1000
    },
    'sphere1_test': {
        'path': 'mbbl.env.LLP.sphere1_test',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphere1': {
        'path': 'mbbl.env.LLP.sphere1',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphere2_test': {
        'path': 'mbbl.env.LLP.sphere2_test',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphere2': {
        'path': 'mbbl.env.LLP.sphere2',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphere3_test': {
        'path': 'mbbl.env.LLP.sphere3_test',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphere3': {
        'path': 'mbbl.env.LLP.sphere3',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'spherebaseline_test': {
        'path': 'mbbl.env.LLP.spherebaseline_test',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'spherebaseline': {
        'path': 'mbbl.env.LLP.spherebaseline',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphereopt_test': {
        'path': 'mbbl.env.LLP.sphereopt_test',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'sphereopt': {
        'path': 'mbbl.env.LLP.sphereopt',
        'ob_size': 5, 'action_size': 5, 'max_length': 1000
    },
    'nonparametric1_test': {
        'path': 'mbbl.env.LLP.nonparametric1_test',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametric1': {
        'path': 'mbbl.env.LLP.nonparametric1',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametric2_test': {
        'path': 'mbbl.env.LLP.nonparametric2_test',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametric2': {
        'path': 'mbbl.env.LLP.nonparametric2',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametric3_test': {
        'path': 'mbbl.env.LLP.nonparametric3_test',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametric3': {
        'path': 'mbbl.env.LLP.nonparametric3',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametricbaseline_test': {
        'path': 'mbbl.env.LLP.nonparametricbaseline_test',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametricbaseline': {
        'path': 'mbbl.env.LLP.nonparametricbaseline',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametricopt': {
        'path': 'mbbl.env.LLP.nonparametricopt',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'nonparametricopt_test': {
        'path': 'mbbl.env.LLP.nonparametricopt_test',
        'ob_size': 1, 'action_size': 1, 'max_length': 1000
    },
    'recommender1': {
        'path': 'mbbl.env.LLP.recommender1',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommender1_test': {
        'path': 'mbbl.env.LLP.recommender1_test',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommender2': {
        'path': 'mbbl.env.LLP.recommender2',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommender2_test': {
        'path': 'mbbl.env.LLP.recommender2_test',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommender3': {
        'path': 'mbbl.env.LLP.recommender3',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommender3_test': {
        'path': 'mbbl.env.LLP.recommender3_test',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommenderbaseline': {
        'path': 'mbbl.env.LLP.recommenderbaseline',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommenderbaseline_test': {
        'path': 'mbbl.env.LLP.recommenderbaseline_test',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommenderopt': {
        'path': 'mbbl.env.LLP.recommenderopt',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
    'recommenderopt_test': {
        'path': 'mbbl.env.LLP.recommenderopt_test',
        'ob_size': 10, 'action_size': 10, 'max_length': 5
    },
})
