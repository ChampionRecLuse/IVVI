...
class env(py_environment.PyEnvironment):
    ...
    def __init__(self, env_name, rand_seed, misc_info):
        ...
        # self.transition = np.array([[ 0.336852  ,-0.22575082,-0.18623363, 0.12961953, 0.22126197]])
        self.transition = np.array([[ 0.33113027,-0.21256289,-0.19251632, 0.12828914, 0.22003255]])
