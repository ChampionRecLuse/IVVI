...
class env(py_environment.PyEnvironment):
    ...
    def __init__(self, env_name, rand_seed, misc_info):
        ...
        # self.transition = np.array([[ 0.34194301,-0.21787026,-0.1349351 , 0.12635033, 0.21591442]])
        self.transition = np.array([[ 0.33813725,-0.22643539,-0.12541801, 0.13193124, 0.21197599]])
