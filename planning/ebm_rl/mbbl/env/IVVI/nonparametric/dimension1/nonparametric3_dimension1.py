...
class env(py_environment.PyEnvironment):
    ...
    def __init__(self, env_name, rand_seed, misc_info):
        ...
        # self.transition = np.array([[ 0.32649329,-0.23802313,-0.24692076, 0.1423935 , 0.22353822]])
        self.transition = np.array([[ 0.32086932,-0.23118307,-0.23942574, 0.13585317, 0.22240751]])
