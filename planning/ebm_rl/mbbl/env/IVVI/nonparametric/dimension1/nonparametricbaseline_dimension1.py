...
class env(py_environment.PyEnvironment):
    ...
    def __init__(self, env_name, rand_seed, misc_info):
        ...
        # self.transition = np.array([[ 0.53781148,-0.38761269, 0.12126886, 0.182147  , 0.01162071]])
        self.transition = np.array([[ 0.55382076,-0.39605517, 0.11454754, 0.18639461,-0.00715203]])
