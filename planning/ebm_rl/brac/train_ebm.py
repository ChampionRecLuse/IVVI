...
from brac import get_agent_data
...
flags.DEFINE_string('env_name', 'IVVI', 'env name.')
flags.DEFINE_integer('seed', 0, 'random seed.')
flags.DEFINE_integer('total_train_steps', int(5e5), '')
flags.DEFINE_integer('n_eval_episodes', 40, '')
...
def main(_):
  ...
  # get_agent_data.train_eval_offline(
  #     log_dir=log_dir,
  #     data_file='replay_final.data-00000-of-00001',
  #     agent_module=agents.AGENT_MODULES_DICT[FLAGS.agent_name],
  #     env_name=FLAGS.env_name,
  #     total_train_steps=FLAGS.total_train_steps,
  #     n_eval_episodes=FLAGS.n_eval_episodes,
